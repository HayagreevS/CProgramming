...
uint8_t create_string_of_eight_1s() {
	...
	return ~(0x00 >> 7);  // TODO:  Rewrite this to use 0x00 and a bitwise operator.
}
...
uint8_t create_string_of_1s_at_left(uint8_t num_1s) {
	...
	return ~0x00 << (8 - num_1s);  // TODO: replace this with a one-line implementation of this function.
}
...
uint8_t create_string_of_1s_at_right(uint8_t num_1s) {
	...
	return ~(~0x00 << (num_1s));  // TODO: replace this with a one-line implementation of this function.
}
...
uint8_t toggle_left_bits(uint8_t byte, uint8_t num_bits_to_toggle) {
	...
	return ((~byte) & (0xff << (8 - num_bits_to_toggle))) | (byte & (0xff >> num_bits_to_toggle));  // TODO: replace this with a one-line implementation of this function.
}
