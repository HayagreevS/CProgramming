...
static int _test_parse_element1() {
	mu_start();
	Element element;
	char const* input = "\"123abc\"123abc";
	char const* pos = input;
	bool is_success = parse_element(&element, &pos);
	mu_check(is_success);
...
static int _test_parse_element2() {
	mu_start();
	Element element;
	char const* input = "\"12\"";
	char const* pos = input;
...
static int _test_parse_element3() {
	mu_start();
	Element element;
	char const* input = "\"a\", \"a\"";
	char const* pos = input;
	bool is_success = parse_element(&element, &pos);
	mu_check(is_success);
	//print_element(element);
...
static int _test_parse_element4() {
	mu_start();
	Element element;
	char const* input = "[]";
	char const* pos = input;
...
static int _test_invalid_element() {
	mu_start();
	char const* input = "[";
	char const* pos = input;
	Element element;
...
static int _test_invalid_element2() {
	mu_start();
	char const* input = "[\"a\", as]";
	char const* pos = input;
	Element element;
	bool is_success = parse_element(&element, &pos);
	mu_check(!is_success);
...
int main(int argc, char* argv[]) {
	...
	*/
	mu_run(_test_parse_element1);
	mu_run(_test_parse_element2);
	mu_run(_test_parse_element3);
	mu_run(_test_parse_element4);
	mu_run(_test_invalid_element);
	mu_run(_test_invalid_element2);
	//mu_run(_test_string);
	//_test_print_element();
	return EXIT_SUCCESS;
}
